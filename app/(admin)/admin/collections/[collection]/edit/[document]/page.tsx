  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          onClick={() => router.back()}
          className="rounded-lg border border-stroke bg-white px-4 py-2 text-black transition hover:bg-gray-100"
        >
          Back
        </button>
      </div>
      ...
      {isLoading ? (
        <div className="rounded-lg border border-stroke bg-white p-6">
          <div className="h-80 animate-pulse rounded-md bg-gray-200"></div>
        </div>
      ) : document ? (
        <DocumentForm
