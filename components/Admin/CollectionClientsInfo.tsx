...
const CollectionClientsInfo = ({ collectionName }) => {
  ...
  // Query function to fetch clientsInfo data
  ...
  const {
    data: clientsInfoData,
    isLoading,
    error,
  } = useQuery({
    queryKey: [`collection-${collectionName}`],
    queryFn: fetchClientsInfoData,
      ...
      <div className="rounded-lg border border-stroke bg-white p-6 shadow-sm dark:border-strokedark dark:bg-black">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-gray-500">
            There was an error loading the clients info section data
          </p>
          <button
...
export default CollectionClientsInfo;
