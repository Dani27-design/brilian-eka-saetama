...
interface SortableMaintenanceHeaderProps {
  children: React.ReactNode;
  sortKey: MaintenanceFilters['sortBy'];
  currentSort: MaintenanceFilters['sortBy'];
  currentOrder: MaintenanceFilters['sortOrder'];
  onSort: (sortKey: MaintenanceFilters['sortBy']) => void;
  className?: string;
}

export default function SortableMaintenanceHeader({
  children,
  sortKey,
  currentSort,
  currentOrder,
  onSort,
  className = ""
}: SortableMaintenanceHeaderProps) {
