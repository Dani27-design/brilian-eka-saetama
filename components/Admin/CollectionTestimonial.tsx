...
const CollectionTestimonial = ({ collectionName }) => {
  ...
  // Query function to fetch testimonial data
      ...
      <div className="rounded-lg border border-stroke bg-white p-6 shadow-sm dark:border-strokedark dark:bg-black">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-gray-500">
            There was an error loading the testimonial section data
          </p>
          <button
...
export default CollectionTestimonial;
