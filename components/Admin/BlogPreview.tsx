...
const BlogPreview = ({
  ...
  const renderBlogItem = (blog: Blog, key: number) => {
    return (
      <div
        className="animate_top rounded-lg bg-white p-4 pb-9 shadow-solid-8"
        key={key}
      >
        ...
        <div className="px-0">
          <h3 className="mb-3 mt-3 line-clamp-2 inline-block text-lg font-medium text-black duration-300 hover:text-primary xl:text-itemtitle2">
    ...
    <div className="mx-auto w-full py-4">
      <div className="mx-auto w-full px-0">
        ...
        <div className="mx-auto text-center">
          ...
          >
            <div className="inline-block rounded-full bg-zumthor px-4.5 py-1.5">
